...
interface ProgramacionGenericaSectionProps {
  apiPath: string;
  cacheKey: string;
  sectionClass: string;
  updatedMsg: string;
...
const ProgramacionGenericaSection: React.FC<ProgramacionGenericaSectionProps> = ({
  apiPath,
  cacheKey,
  sectionClass,
  updatedMsg,
...
export default ProgramacionGenericaSection;
